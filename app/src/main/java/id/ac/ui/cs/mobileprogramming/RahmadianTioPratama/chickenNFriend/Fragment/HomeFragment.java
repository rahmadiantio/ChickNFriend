...
import id.ac.ui.cs.mobileprogramming.RahmadianTioPratama.chickenNFriend.Activity.MenuPerKategoriActivity;
...
//import id.ac.ui.cs.mobileprogramming.RahmadianTioPratama.chickenNFriend.adapter.HidanganAdapter;
import id.ac.ui.cs.mobileprogramming.RahmadianTioPratama.chickenNFriend.adapter.RecyclerViewHidangan;
...
//        Toast.makeText(getActivity(), "jumlah hidangan "+jmlHidangan, Toast.LENGTH_SHORT).show();
        ...
        /**
         * Bagian untuk melihat menu per kategori
         */
